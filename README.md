...
Full Stack & Mobile Developer from Costa Rica 🇨🇷 — 4+ years building scalable apps with clean architecture.

```ts
const jonathan = {
  role: "Full Stack & Mobile Developer",
  stack: ["Flutter", "NestJS", "Angular", "PostgreSQL"],
  principles: ["Clean Architecture", "SOLID", "DRY"],
  currentlyBuilding: "ACDEMIC — a SaaS for educators",
};
```
...
Building **ACDEMIC**, a SaaS platform for educators — focused on clean, scalable architecture and a great user experience.
